    ...
    $.getJSON('./userinfo_json/PlayCount.json', function (data2) {
        $.getJSON('./userinfo_json/' + username + '.json', function (data) {
            ...
            $.each(data.data, function (i, item) {
                ...
                switch (item.Rank) {
                    case 8:
                        html.push('<td  class="Rank"><a href = "../songinfo/index.html?title=' + encodeURIComponent(item.Title) +'"><aa style="display:none">8</aa>' + "AAA" + '</a></td>');
                        break;
                    case 7:
                        html.push('<td  class="Rank"><a href = "../songinfo/index.html?title=' + encodeURIComponent(item.Title) + '"><aa style="display:none">7</aa>' + "AA" + '</a></td>');
                        break;
                    case 6:
                        html.push('<td  class="Rank"><a href = "../songinfo/index.html?title=' + encodeURIComponent(item.Title) + '"><aa style="display:none">6</aa>' + "A" + '</a></td>');
                        break;
                    case 5:
                        html.push('<td  class="Rank"><a href = "../songinfo/index.html?title=' + encodeURIComponent(item.Title) + '"><aa style="display:none">5</aa>' + "B" + '</a></td>');
                        break;
                    case 4:
                        html.push('<td  class="Rank"><a href = "../songinfo/index.html?title=' + encodeURIComponent(item.Title) + '"><aa style="display:none">4</aa>' + "C" + '</a></td>');
                        break;
                    case 3:
                        html.push('<td  class="Rank"><a href = "../songinfo/index.html?title=' + encodeURIComponent(item.Title) + '"><aa style="display:none">3</aa>' + "D" + '</a></td>');
                        break;
                    case 2:
                        html.push('<td  class="Rank"><a href = "../songinfo/index.html?title=' + encodeURIComponent(item.Title) + '"><aa style="display:none">2</aa>' + "E" + '</a></td>');
                        break;
                    case 1:
                        html.push('<td  class="Rank"><a href = "../songinfo/index.html?title=' + encodeURIComponent(item.Title) + '"><aa style="display:none">1</aa>' + "F" + '</a></td>');
                        break;
                    case 0:
                        html.push('<td  class="Rank"><a href = "../songinfo/index.html?title=' + encodeURIComponent(item.Title) + '"><aa style="display:none">0</aa>' + "---" + '</a></td>');
                        break;
                }
